...
# Load dataset here 
```{r}
load("~/Documents/UMICH/Winter_21/LHS_610/Week9/namcs08.rdata")
...
- Use a nearest neighbors model and a decision tree to train on the training set and make predictions on the test set
...
Q3 Answer: The area under the curve helps to understand performance at various thresholds
